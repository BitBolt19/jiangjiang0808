...
// HdContractEventColumns defines and stores column names for the table hd_contract_event.
...
// hdContractEventColumns holds the columns for the table hd_contract_event.
