...
func (_Nft *NftCaller) MINTROLE(opts *bind.CallOpts) ([32]byte, error) {
	var out []interface{}
	err := _Nft.contract.Call(opts, &out, "MINT_ROLE")
...
//
// Solidity: function MINT_ROLE() view returns(bytes32)
func (_Nft *NftSession) MINTROLE() ([32]byte, error) {
	return _Nft.Contract.MINTROLE(&_Nft.CallOpts)
}

// MINTROLE is a free data retrieval call binding the contract method 0xe9a9c850.
//
// Solidity: function MINT_ROLE() view returns(bytes32)
func (_Nft *NftCallerSession) MINTROLE() ([32]byte, error) {
	return _Nft.Contract.MINTROLE(&_Nft.CallOpts)
}
...
func (_Nft *NftCaller) AllowTestChainId(opts *bind.CallOpts, arg0 *big.Int) (*big.Int, error) {
	var out []interface{}
	err := _Nft.contract.Call(opts, &out, "allowTestChainId", arg0)
...
//
// Solidity: function allowTestChainId(uint256 ) view returns(uint256)
func (_Nft *NftSession) AllowTestChainId(arg0 *big.Int) (*big.Int, error) {
	return _Nft.Contract.AllowTestChainId(&_Nft.CallOpts, arg0)
}

// AllowTestChainId is a free data retrieval call binding the contract method 0x10d62c99.
//
// Solidity: function allowTestChainId(uint256 ) view returns(uint256)
func (_Nft *NftCallerSession) AllowTestChainId(arg0 *big.Int) (*big.Int, error) {
	return _Nft.Contract.AllowTestChainId(&_Nft.CallOpts, arg0)
}
...
// GetTokenIdsByIndex is a free data retrieval call binding the contract method 0x7a110ca1.
//
// Solidity: function getTokenIdsByIndex(address _owner, uint256 _index) view returns(uint256[])
func (_Nft *NftCaller) GetTokenIdsByIndex(opts *bind.CallOpts, _owner common.Address, _index *big.Int) ([]*big.Int, error) {
	var out []interface{}
	err := _Nft.contract.Call(opts, &out, "getTokenIdsByIndex", _owner, _index)
...
//
// Solidity: function getTokenIdsByIndex(address _owner, uint256 _index) view returns(uint256[])
func (_Nft *NftSession) GetTokenIdsByIndex(_owner common.Address, _index *big.Int) ([]*big.Int, error) {
	return _Nft.Contract.GetTokenIdsByIndex(&_Nft.CallOpts, _owner, _index)
}

// GetTokenIdsByIndex is a free data retrieval call binding the contract method 0x7a110ca1.
//
// Solidity: function getTokenIdsByIndex(address _owner, uint256 _index) view returns(uint256[])
func (_Nft *NftCallerSession) GetTokenIdsByIndex(_owner common.Address, _index *big.Int) ([]*big.Int, error) {
	return _Nft.Contract.GetTokenIdsByIndex(&_Nft.CallOpts, _owner, _index)
}
...
func (_Nft *NftCaller) IsAllowTestChainId(opts *bind.CallOpts) (bool, error) {
	var out []interface{}
	err := _Nft.contract.Call(opts, &out, "isAllowTestChainId")
...
//
// Solidity: function isAllowTestChainId() view returns(bool)
func (_Nft *NftSession) IsAllowTestChainId() (bool, error) {
	return _Nft.Contract.IsAllowTestChainId(&_Nft.CallOpts)
}

// IsAllowTestChainId is a free data retrieval call binding the contract method 0x996101d2.
//
// Solidity: function isAllowTestChainId() view returns(bool)
func (_Nft *NftCallerSession) IsAllowTestChainId() (bool, error) {
	return _Nft.Contract.IsAllowTestChainId(&_Nft.CallOpts)
}
...
func (_Nft *NftCaller) SupportsInterface(opts *bind.CallOpts, _interfaceId [4]byte) (bool, error) {
	var out []interface{}
	err := _Nft.contract.Call(opts, &out, "supportsInterface", _interfaceId)
...
//
// Solidity: function supportsInterface(bytes4 _interfaceId) view returns(bool)
func (_Nft *NftSession) SupportsInterface(_interfaceId [4]byte) (bool, error) {
	return _Nft.Contract.SupportsInterface(&_Nft.CallOpts, _interfaceId)
}

// SupportsInterface is a free data retrieval call binding the contract method 0x01ffc9a7.
//
// Solidity: function supportsInterface(bytes4 _interfaceId) view returns(bool)
func (_Nft *NftCallerSession) SupportsInterface(_interfaceId [4]byte) (bool, error) {
	return _Nft.Contract.SupportsInterface(&_Nft.CallOpts, _interfaceId)
}
...
func (_Nft *NftTransactor) AddTestChain(opts *bind.TransactOpts, _chainIds []*big.Int) (*types.Transaction, error) {
	return _Nft.contract.Transact(opts, "addTestChain", _chainIds)
}

// AddTestChain is a paid mutator transaction binding the contract method 0x1baba99e.
//
// Solidity: function addTestChain(uint256[] _chainIds) returns()
func (_Nft *NftSession) AddTestChain(_chainIds []*big.Int) (*types.Transaction, error) {
	return _Nft.Contract.AddTestChain(&_Nft.TransactOpts, _chainIds)
}

// AddTestChain is a paid mutator transaction binding the contract method 0x1baba99e.
//
// Solidity: function addTestChain(uint256[] _chainIds) returns()
func (_Nft *NftTransactorSession) AddTestChain(_chainIds []*big.Int) (*types.Transaction, error) {
	return _Nft.Contract.AddTestChain(&_Nft.TransactOpts, _chainIds)
}
...
//
// Solidity: function batchMint(address[] _users, uint256[] _amounts) returns()
func (_Nft *NftTransactor) BatchMint(opts *bind.TransactOpts, _users []common.Address, _amounts []*big.Int) (*types.Transaction, error) {
	return _Nft.contract.Transact(opts, "batchMint", _users, _amounts)
}

// BatchMint is a paid mutator transaction binding the contract method 0x68573107.
//
// Solidity: function batchMint(address[] _users, uint256[] _amounts) returns()
func (_Nft *NftSession) BatchMint(_users []common.Address, _amounts []*big.Int) (*types.Transaction, error) {
	return _Nft.Contract.BatchMint(&_Nft.TransactOpts, _users, _amounts)
}

// BatchMint is a paid mutator transaction binding the contract method 0x68573107.
//
// Solidity: function batchMint(address[] _users, uint256[] _amounts) returns()
func (_Nft *NftTransactorSession) BatchMint(_users []common.Address, _amounts []*big.Int) (*types.Transaction, error) {
	return _Nft.Contract.BatchMint(&_Nft.TransactOpts, _users, _amounts)
}

// DoMint is a paid mutator transaction binding the contract method 0x1fa30523.
//
// Solidity: function doMint(address _member, uint256 _amount) returns()
func (_Nft *NftTransactor) DoMint(opts *bind.TransactOpts, _member common.Address, _amount *big.Int) (*types.Transaction, error) {
	return _Nft.contract.Transact(opts, "doMint", _member, _amount)
}

// DoMint is a paid mutator transaction binding the contract method 0x1fa30523.
//
// Solidity: function doMint(address _member, uint256 _amount) returns()
func (_Nft *NftSession) DoMint(_member common.Address, _amount *big.Int) (*types.Transaction, error) {
	return _Nft.Contract.DoMint(&_Nft.TransactOpts, _member, _amount)
}

// DoMint is a paid mutator transaction binding the contract method 0x1fa30523.
//
// Solidity: function doMint(address _member, uint256 _amount) returns()
func (_Nft *NftTransactorSession) DoMint(_member common.Address, _amount *big.Int) (*types.Transaction, error) {
	return _Nft.Contract.DoMint(&_Nft.TransactOpts, _member, _amount)
}
...
func (_Nft *NftTransactor) FreeMint(opts *bind.TransactOpts, _amount *big.Int) (*types.Transaction, error) {
	return _Nft.contract.Transact(opts, "freeMint", _amount)
}

// FreeMint is a paid mutator transaction binding the contract method 0x7c928fe9.
//
// Solidity: function freeMint(uint256 _amount) returns()
func (_Nft *NftSession) FreeMint(_amount *big.Int) (*types.Transaction, error) {
	return _Nft.Contract.FreeMint(&_Nft.TransactOpts, _amount)
}

// FreeMint is a paid mutator transaction binding the contract method 0x7c928fe9.
//
// Solidity: function freeMint(uint256 _amount) returns()
func (_Nft *NftTransactorSession) FreeMint(_amount *big.Int) (*types.Transaction, error) {
	return _Nft.Contract.FreeMint(&_Nft.TransactOpts, _amount)
}
