...
//
// Solidity: function getTokenIdsByIndex(address owner, uint256 index) view returns(uint256[])
func (_Nft *NftCaller) GetTokenIdsByIndex(opts *bind.CallOpts, owner common.Address, index *big.Int) ([]*big.Int, error) {
	var out []interface{}
	err := _Nft.contract.Call(opts, &out, "getTokenIdsByIndex", owner, index)
...
//
// Solidity: function getTokenIdsByIndex(address owner, uint256 index) view returns(uint256[])
func (_Nft *NftSession) GetTokenIdsByIndex(owner common.Address, index *big.Int) ([]*big.Int, error) {
	return _Nft.Contract.GetTokenIdsByIndex(&_Nft.CallOpts, owner, index)
}

// GetTokenIdsByIndex is a free data retrieval call binding the contract method 0x7a110ca1.
//
// Solidity: function getTokenIdsByIndex(address owner, uint256 index) view returns(uint256[])
func (_Nft *NftCallerSession) GetTokenIdsByIndex(owner common.Address, index *big.Int) ([]*big.Int, error) {
	return _Nft.Contract.GetTokenIdsByIndex(&_Nft.CallOpts, owner, index)
}
...
//
// Solidity: function batchMint(address[] _users, uint256[] _amunts) returns()
func (_Nft *NftTransactor) BatchMint(opts *bind.TransactOpts, _users []common.Address, _amunts []*big.Int) (*types.Transaction, error) {
	return _Nft.contract.Transact(opts, "batchMint", _users, _amunts)
}

// BatchMint is a paid mutator transaction binding the contract method 0x68573107.
//
// Solidity: function batchMint(address[] _users, uint256[] _amunts) returns()
func (_Nft *NftSession) BatchMint(_users []common.Address, _amunts []*big.Int) (*types.Transaction, error) {
	return _Nft.Contract.BatchMint(&_Nft.TransactOpts, _users, _amunts)
}

// BatchMint is a paid mutator transaction binding the contract method 0x68573107.
//
// Solidity: function batchMint(address[] _users, uint256[] _amunts) returns()
func (_Nft *NftTransactorSession) BatchMint(_users []common.Address, _amunts []*big.Int) (*types.Transaction, error) {
	return _Nft.Contract.BatchMint(&_Nft.TransactOpts, _users, _amunts)
}

// DoMint is a paid mutator transaction binding the contract method 0x1fa30523.
//
// Solidity: function doMint(address member, uint256 amount) returns()
func (_Nft *NftTransactor) DoMint(opts *bind.TransactOpts, member common.Address, amount *big.Int) (*types.Transaction, error) {
	return _Nft.contract.Transact(opts, "doMint", member, amount)
}

// DoMint is a paid mutator transaction binding the contract method 0x1fa30523.
//
// Solidity: function doMint(address member, uint256 amount) returns()
func (_Nft *NftSession) DoMint(member common.Address, amount *big.Int) (*types.Transaction, error) {
	return _Nft.Contract.DoMint(&_Nft.TransactOpts, member, amount)
}

// DoMint is a paid mutator transaction binding the contract method 0x1fa30523.
//
// Solidity: function doMint(address member, uint256 amount) returns()
func (_Nft *NftTransactorSession) DoMint(member common.Address, amount *big.Int) (*types.Transaction, error) {
	return _Nft.Contract.DoMint(&_Nft.TransactOpts, member, amount)
}
