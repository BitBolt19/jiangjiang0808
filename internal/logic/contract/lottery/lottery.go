...
// IsCanTriggerLottery is a free data retrieval call binding the contract method 0xb230088b.
//
// Solidity: function isCanTriggerLottery() view returns(bool)
func (_Lottery *LotteryCaller) IsCanTriggerLottery(opts *bind.CallOpts) (bool, error) {
	var out []interface{}
	err := _Lottery.contract.Call(opts, &out, "isCanTriggerLottery")
...
//
// Solidity: function isCanTriggerLottery() view returns(bool)
func (_Lottery *LotterySession) IsCanTriggerLottery() (bool, error) {
	return _Lottery.Contract.IsCanTriggerLottery(&_Lottery.CallOpts)
}

// IsCanTriggerLottery is a free data retrieval call binding the contract method 0xb230088b.
//
// Solidity: function isCanTriggerLottery() view returns(bool)
func (_Lottery *LotteryCallerSession) IsCanTriggerLottery() (bool, error) {
	return _Lottery.Contract.IsCanTriggerLottery(&_Lottery.CallOpts)
}
...
// Test1 is a paid mutator transaction binding the contract method 0x19ae8994.
//
// Solidity: function test1(uint256 _round) returns()
func (_Lottery *LotteryTransactor) Test1(opts *bind.TransactOpts, _round *big.Int) (*types.Transaction, error) {
	return _Lottery.contract.Transact(opts, "test1", _round)
}

// Test1 is a paid mutator transaction binding the contract method 0x19ae8994.
//
// Solidity: function test1(uint256 _round) returns()
func (_Lottery *LotterySession) Test1(_round *big.Int) (*types.Transaction, error) {
	return _Lottery.Contract.Test1(&_Lottery.TransactOpts, _round)
}

// Test1 is a paid mutator transaction binding the contract method 0x19ae8994.
//
// Solidity: function test1(uint256 _round) returns()
func (_Lottery *LotteryTransactorSession) Test1(_round *big.Int) (*types.Transaction, error) {
	return _Lottery.Contract.Test1(&_Lottery.TransactOpts, _round)
}

// Test2 is a paid mutator transaction binding the contract method 0xcaf44683.
//
// Solidity: function test2(uint256 _round) returns()
func (_Lottery *LotteryTransactor) Test2(opts *bind.TransactOpts, _round *big.Int) (*types.Transaction, error) {
	return _Lottery.contract.Transact(opts, "test2", _round)
}

// Test2 is a paid mutator transaction binding the contract method 0xcaf44683.
//
// Solidity: function test2(uint256 _round) returns()
func (_Lottery *LotterySession) Test2(_round *big.Int) (*types.Transaction, error) {
	return _Lottery.Contract.Test2(&_Lottery.TransactOpts, _round)
}

// Test2 is a paid mutator transaction binding the contract method 0xcaf44683.
//
// Solidity: function test2(uint256 _round) returns()
func (_Lottery *LotteryTransactorSession) Test2(_round *big.Int) (*types.Transaction, error) {
	return _Lottery.Contract.Test2(&_Lottery.TransactOpts, _round)
}
